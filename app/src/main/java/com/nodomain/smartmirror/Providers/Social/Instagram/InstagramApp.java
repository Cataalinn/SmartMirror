...
public class InstagramApp {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.e(TAG, "Opening Token URL " + url.toString());
    ...
    public void getFollowRequests() {
        String url = API_URL + "users/self/media/recent/?access_token=" + mSession.getAccessToken();
        new GetFollowRequests().execute(url);
    }
